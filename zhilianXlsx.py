    ...
    for page in range(1, 35):
        ...
        for i in range(0, len(urls)):
            if add_url(urls[i]):
                ...
                mysheet.write(j, 0, param[1])
                mysheet.write(j, 0, param[2])
                mysheet.write(j, 0, param[3])
                mysheet.write(j, 0, param[4])
                mysheet.write(j, 0, param[5])
                mysheet.write(j, 0, param[6])
                mysheet.write(j, 0, param[7])
                mysheet.write(j, 0, param[8])
                mysheet.write(j, 0, param[9])
                mysheet.write(j, 0, param[10])
                mysheet.write(j, 0, param[11])
                mysheet.write(j, 0, param[12])
                # 行序递增
                j += 1
        ...
        # 保存工作表
        workbook.save(str(city) + '第' + str(page) + '页结果.xlx')
        # 打印消息
